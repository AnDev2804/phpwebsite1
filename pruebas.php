...
function crearDesendencia($papa, $mama){
            ...
            $a = combinaciones("a",$papa,$mama);

            $b = combinaciones("b",$papa,$mama);
            
            $c = combinaciones("c",$papa,$mama);
            
            $d = combinaciones("d",$papa,$mama);
            
            $e = combinaciones("e",$papa,$mama);
            
            $f = combinaciones("f",$papa,$mama);
            
            $g = combinaciones("g",$papa,$mama);
            
            $h = combinaciones("h",$papa,$mama);
...
function combinaciones($letra,$papa, $mama){
